...
#= to work on locolization prediction
...
def classify_a_file(infile2, pickle_file, datafile, cols_to_drop, cols2drop_for_locapredi=cols2drop_for_locapredi):
  k = 100 #The k used in classify_a_file must be the same as the k used in model.pkl
...
# file1 = '../input/GSM1087976_d1F2.contig_features.addref.rm_nonfeat.consistent.tsv'
# file2 = '../input/GSM1087984_r2FNa2.contig_features.addref.rm_nonfeat.consistent.tsv'
# file3 = '../input/GSM1087987_C0FCSb.contig_features.addref.rm_nonfeat.consistent.tsv'
# file4 = '../Unittest_pickle_classifyAfile/GSM1087987_C0FCSb.contig_features.addref.rm_nonfeat.consistent.tsv'
